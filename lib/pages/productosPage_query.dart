...
class productosPage_query extends StatefulWidget {
  const productosPage_query({Key? key}) : super(key: key);
...
class _productosPage_queryState extends State<productosPage_query> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: appBarProductosQuery(context),
  ...
  AppBar appBarProductosQuery(BuildContext context) {
    return AppBar(
      elevation: 1,
