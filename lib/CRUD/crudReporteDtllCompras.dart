...
class DbCrudReporteDetalleCompras {
  ...
  Future<List<Reportedtllecompras>> GetDetalleReporteCompras(String id) async {
    ...
    final res = await db.rawQuery(
        'SELECT DC.iddetacomp AS "COD",P.nombprod AS "PROD",DC.preciooldcomp AS "PRECIOANT",DC.preciocprod AS "PRECIO",DC.preciovprod AS "PRECVENT",DC.cantprod AS "CANT" FROM DETACOMPRA DC INNER JOIN PRODUCTOS P ON DC.idprod=P.idprod WHERE DC.iddetacomp="$id";');
