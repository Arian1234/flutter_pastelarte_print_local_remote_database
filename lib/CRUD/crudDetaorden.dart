...
class DbCrudDetaorden {
  static final DbCrudDetaorden dbp = DbCrudDetaorden._();
  DbCrudDetaorden._();
  Future<int> NuevoDetaorden(Detaorden detaorden) async {
    final db = await DBProvider.db.getdatabase();
    final res = await db.insert('DETAORDEN', detaorden.toJson());
    return res;
  }
